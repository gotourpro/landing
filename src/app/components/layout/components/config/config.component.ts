...
import { LayoutService, MenuColorScheme, MenuMode } from '../../../../services/layout.service';
...
export class ConfigComponent implements OnInit {
    ...
    public set menuMode(_val: MenuMode) {
        this.layoutService.config.update((config) => ({
            ...config,
            menuMode: _val,
        }));
    ...
    public get menuTheme(): MenuColorScheme {
        return this.layoutService.config().menuTheme;
    }

    public set menuTheme(_val: MenuColorScheme) {
        this.layoutService.config.update((config) => ({
            ...config,
            menuTheme: _val,
        }));
